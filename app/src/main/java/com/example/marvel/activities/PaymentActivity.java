...
public class PaymentActivity extends AppCompatActivity {
    ...
    private final String Jazz_MerchantID      = "MC19973";
    private final String Jazz_Password        = "95ydv3u9y1";
    private final String Jazz_IntegritySalt   = "2w9h31d43y";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDoalog = new ProgressDialog(PaymentActivity.this);
        ...
        System.out.println("paymentLog price_before : " +price);

        String[] values = price.split("\\.");
        price = values[0];
        price = price + "00";
        System.out.println("paymentLog price : " +price);

        Date Date = new Date();
        SimpleDateFormat dateFormat = new SimpleDateFormat("yyyyMMddkkmmss");
        String DateString = dateFormat.format(Date);
        System.out.println("paymentLog DateString : " +DateString);
        ...
        System.out.println("paymentLog: expiryDateString : " +expiryDateString);

        String TransactionIdString = "T" + DateString;
        System.out.println("paymentLog: TransactionIdString : " +TransactionIdString);
        ...
        pp_SecureHash = php_hash_hmac(sortedString, IntegritySalt);
        System.out.println("paymentLog: sortedString : " +sortedString);
        System.out.println("paymentLog: pp_SecureHash : " +pp_SecureHash);
        ...
        System.out.println("paymentLog: postData : " +postData);
    ...
    private class MyWebViewClient extends WebViewClient {
        ...
        public void onPageStarted(WebView view, String url, Bitmap favicon) {
            ...
            if(url.equals(paymentReturnUrl)){
                System.out.println("paymentLog: return url cancelling");
                view.stopLoading();
                return;
            }
    ...
    private class FormDataInterface {
        ...
        public void processFormData(String url, String formData) {
            ...
            System.out.println("paymentLog: Url:" + url + " form data " + formData);
            if (url.equals(paymentReturnUrl)) {
                String[] values = formData.split("&");
                for (String pair : values) {
                    String[] nameValue = pair.split("=");
                    if (nameValue.length == 2) {
                        System.out.println("paymentLog: Name:" + nameValue[0] + " value:" + nameValue[1]);
